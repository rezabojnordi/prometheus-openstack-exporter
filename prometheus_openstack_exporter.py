...
class SwiftAccountUsage():
    def __init__(self):
        ...
        try:
            ...
            raise Exception(
                "Is swift.conf readable or at least one hash path variable configured? please check configuration Swift or comment enabled_collectors: #SwiftAccountUsage,#swift  in prometheus-openstack-exporter.yaml")
